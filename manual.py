def manual():
    print(
        ...
        "=" * 55,
        "func:",
        'sytax structure: "func name:body"',
        "function definition command\n",
        "print:",
        'syntax structure: "print(content1,...,contentN)',
        "prints content of a variable or a string",
        sep="\n",
    )
...
def cpecm():
    print(
        "Compass Pharsing and Execution Console Manual",
        "=" * 55,
        ...
        '"$cpec" Prints the manual for CPEC',
        sep="\n",
    )
